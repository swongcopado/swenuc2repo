/*
 ...
 dhtmlxScheduler v.5.2.1 Professional
...
// bar mode
        ...
        scheduler._timeline_get_html_for_bar = function(x_ind, y_ind, view, ev, cellLeftPos, nestedEvents) {
            ...
            // SHAI: EDITS TO SUPPORT UTILIZATION VIEW

            if (scheduler._mode === 'MonthlyView') {
                content = scheduler.templates[view.name+"_cell_value"](view._trace_x[x_ind], view.y_unit[y_ind]) || '';
            }
            ...
            return "<div class='dhx_matrix_cell dhx_timeline_data_cell " +
                ...
                "' style='width:" + (scheduler._cols[x_ind]) + "px; left:" + (cellLeftPos) + "px;'  data-col-id='"+ x_ind +"' data-col-date='"+cellDate+"' >"+
...
// define timeline scroll behavior and attach onscroll event
        function initScroll(d, view, heights, render_stats) {
            ...
            dataWrapperDiv.onscroll = function (e) {
                ...
                if (view.render != 'cell') {
                    if (window.requestAnimationFrame) {
                        ...
                        frameRequest = requestAnimationFrame(function () {
                            ...
                            frameRequest = 0;
                            view.callEvent("onScroll", [dataWrapperDiv.scrollLeft, dataWrapperDiv.scrollTop]);
                        });
                    } else {
                        scheduler._timeline_smart_render.updateEvents(view, viewPort);
                    }
                ...
                scheduler._timeline_save_scroll_pos(view, newTop, newLeft);
                if (!asyncScroll) {
