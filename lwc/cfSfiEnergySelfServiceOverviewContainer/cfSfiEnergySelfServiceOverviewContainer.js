import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergySelfServiceOverviewContainer extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfSfiEnergySelfServiceOverviewContainer';
        ...
        @api set cfFirstName(val) {
          ...
          return this._sessionApiVars["FirstName"] || "undefined";
        }
