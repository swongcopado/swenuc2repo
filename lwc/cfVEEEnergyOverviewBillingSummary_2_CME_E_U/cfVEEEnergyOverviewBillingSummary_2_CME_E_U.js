import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEEnergyOverviewBillingSummary_2_CME_E_U extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={VEEConsolePaperLessBilling:"Paperless Billing",
      VEEConsoleActivePaymentPlan:"Active Payment Plan",
      VEEConsoleOverdueBillsMsg:"Overdue Bills",
      VEEConsoleNoPaymentPlanMsg:"No payment plan currently available",
      VEEConsoleNextPayment:"Next Payment",
      VEEConsolePaymentStartDate:"Start Date",
      VEEConsoleBillingPaymentPlan:"Payment Plan",
      ...
      VEEConsoleBillingLabel4:"to avoid disconnection",
      VEEConsoleBillingLabel3:"or pay",
      VEEConsoleBillingLabel2:"is due on",
      VEEConsoleBillingPaymentLabel1:"Next Payment of"
      };
              pubsubEvent = [];
              customEvent = [];
