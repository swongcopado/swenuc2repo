...
import { OMNIDEF } from './vplEnergyAddUpdateContactMultiLanguage_def.js';
import tmpl from './vplEnergyAddUpdateContactMultiLanguage.html';
import tmpl_nds from './vplEnergyAddUpdateContactMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyAddUpdateContactMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
