import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEEnergyCustomerStoryOpportunity extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={VEEConsoleStage:"Stage",
      VEEConsoleAmount:"Amount"
      };
              connectedCallback() {
