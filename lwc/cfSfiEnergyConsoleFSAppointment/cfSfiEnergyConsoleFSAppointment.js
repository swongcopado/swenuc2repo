import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyConsoleFSAppointment extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={sfiEnergyConsoleFSAppointmentConfirmed:"Appointment Confirmed",
      sfiEnergyConsoleFSCaseId:"Case Id",
      sfiEnergyConsoleFSWorkType:"Work Type",
      sfiEnergyConsoleFSContactPerson:"Contact Person",
      sfiEnergyConsoleFSStatus:"Status",
      sfiEnergyConsoleFSLocation:"Location",
      sfiEnergyConsoleFSDateAndTime:"Date and Time",
      sfiEnergyConsoleFSReschedule:"Reschedule"
      };
              pubsubEvent = [];
              customEvent = [];
