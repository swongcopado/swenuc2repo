import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEEnergyCustomerStoryEvent extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={VEEConsoleAccount:"Account",
      VEEConsoleTime:"Time",
      VEEConsoleLocation:"Location",
      VEEConsoleType:"Type"
      };
              connectedCallback() {
