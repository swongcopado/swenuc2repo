import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumerLandingScreen extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={VEELandingPageFooter:"Get a quote in less than 30 secs. Just enter your requirements and get started. It's easy - promise!",
      VEECustomersQuote:"Over 2,329 happy customers",
      VEEServicabilityQuote:"Choose energy that is sustainably generated from renewable resources. No gimmicks. No carbon offsetting. Just 100% sustainable energy for people who care about our environment. ",
      VEECheckServicablityButton:"Check Serviciability",
      VEEServicabilityText:"Thinking about switching your energy tariff? We are here to help you! All we need is your locality  and a bit of information about you. ",
      VEEEnrollInText:"Enroll in 3 easy steps",
      VEEInLessThanText:"in less than 30 seconds",
      VEEGetPersonalisedQuote:"Get Personalized Quote",
      VEELandingPageHeader:"Get the best energy plan to suit your needs"
      };
              connectedCallback() {
