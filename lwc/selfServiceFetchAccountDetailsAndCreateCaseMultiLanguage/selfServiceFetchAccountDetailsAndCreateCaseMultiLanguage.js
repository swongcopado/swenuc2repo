...
import { OMNIDEF } from './selfServiceFetchAccountDetailsAndCreateCaseMultiLanguage_def.js';
import tmpl from './selfServiceFetchAccountDetailsAndCreateCaseMultiLanguage.html';
import tmpl_nds from './selfServiceFetchAccountDetailsAndCreateCaseMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class selfServiceFetchAccountDetailsAndCreateCaseMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
