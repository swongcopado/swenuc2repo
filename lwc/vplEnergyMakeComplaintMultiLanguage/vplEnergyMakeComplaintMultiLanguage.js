...
import { OMNIDEF } from './vplEnergyMakeComplaintMultiLanguage_def.js';
import tmpl from './vplEnergyMakeComplaintMultiLanguage.html';
import tmpl_nds from './vplEnergyMakeComplaintMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyMakeComplaintMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
