...
import { OMNIDEF } from './vplEnergyRequestBillMultiLanguage_def.js';
import tmpl from './vplEnergyRequestBillMultiLanguage.html';
import tmpl_nds from './vplEnergyRequestBillMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyRequestBillMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
