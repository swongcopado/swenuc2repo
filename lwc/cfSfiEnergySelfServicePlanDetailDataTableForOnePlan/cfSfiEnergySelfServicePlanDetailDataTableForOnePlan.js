import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergySelfServicePlanDetailDataTableForOnePlan extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfSfiEnergySelfServicePlanDetailDataTableForOnePlan';
        ...
        SfiEnergySelfServiceTariff:"Tariff"
        };
              pubsubEvent = [];
              customEvent = [];
