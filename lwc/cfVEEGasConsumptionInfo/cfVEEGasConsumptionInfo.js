import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEGasConsumptionInfo extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfVEEGasConsumptionInfo';
              ...
              @track Label={VEEGasLowUsageMsg:"Typically, low consumption homes: Have around 1-2 bedrooms, Have 2-3 occupants, May have people home during the day",
      VEEGasHighUsageMsg:"Typically, high consumption homes: Have around 8 bedrooms, Have 8-10 occupants, May have people home during the day",
      VEEGasMediumUsageMsg:"Typically, medium consumption homes: Have around 3 bedrooms, Have 3-5 occupants, May have people home during the day",
      VEEConsumptionInfoMsgTitle:"Estimating consumption"
      };
              pubsubEvent = [];
              customEvent = [];
