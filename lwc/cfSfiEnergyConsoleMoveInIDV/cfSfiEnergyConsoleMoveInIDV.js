import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyConsoleMoveInIDV extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfSfiEnergyConsoleMoveInIDV';
              ...
              @track Label={SfiEnergyConsoleMoveIn:"Start Service"
        };
              pubsubEvent = [];
              customEvent = [];
