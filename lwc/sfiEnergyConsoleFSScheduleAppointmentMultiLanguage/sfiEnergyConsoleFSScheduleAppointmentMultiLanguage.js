...
import { OMNIDEF } from './sfiEnergyConsoleFSScheduleAppointmentMultiLanguage_def.js';
import tmpl from './sfiEnergyConsoleFSScheduleAppointmentMultiLanguage.html';
import tmpl_nds from './sfiEnergyConsoleFSScheduleAppointmentMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sfiEnergyConsoleFSScheduleAppointmentMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
