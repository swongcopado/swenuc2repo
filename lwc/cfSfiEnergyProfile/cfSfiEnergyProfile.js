import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyProfile extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={sfiEnergyConsoleProfileAnalysis:"Analysis",
      sfiEnergyConsoleProfileRenewablePotential:"Renewable Potential",
      sfiEnergyConsoleProfileUpsellPotential:"Upsell Potential",
      sfiEnergyConsoleProfileMood:"Mood",
      sfiEnergyConsoleProfileCustomerSatisfaction:"Customer Satisfaction",
      sfiEnergyConsoleProfileUsageCharges:"Usage Charges",
      sfiEnergyConsoleProfileMaintainence:"Maintainence",
      sfiEnergyConsoleProfileService:"Service",
      sfiEnergyConsoleProfileCoverage:"Coverage",
      sfiEnergyConsoleProfileReliability:"Reliability",
      sfiEnergyConsoleProfilePurchaseCriteria:"Purchase Criteria",
      sfiEnergyConsoleProfileInsurance:"Insurance",
      sfiEnergyConsoleProfileServiceAvailability:"Service Availability",
      sfiEnergyConsoleProfileFamilyFriendly:"Family Friendly",
      sfiEnergyConsoleProfileRenewableEnergy:"Renewable Energy",
      sfiEnergyConsoleProfileCost:"Cost",
      sfiEnergyConsoleProductInterests:"Product Interests",
      sfiEnergyConsoleManageProfileAttributes:"Manage Profile Attributes"
      };
              connectedCallback() {
              ...
              registerPubSub() {
                this.template.addEventListener('energyprofileinterestadded', this.handleEventAction.bind(this, data.events[0],0));
              }
