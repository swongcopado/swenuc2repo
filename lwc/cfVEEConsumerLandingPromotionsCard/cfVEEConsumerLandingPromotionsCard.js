import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumerLandingPromotionsCard extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={VEEPromotion5:"I would definitely recommend Quality Watts to my friends and family.",
      VEEPromotion4:"Our customers save £100s every year spend more on the things that really matter.",
      VEEPromotion3:"Prices calculated in the simplest way possible.",
      VEEPromotion2:"Monitor Energy usage and pay for just what you use",
      VEEPromotion1:"There are no pipes, wires or meters to install."
      };
              connectedCallback() {
