...
import { OMNIDEF } from './vplEnergyUpdateAccountMultiLanguage_def.js';
import tmpl from './vplEnergyUpdateAccountMultiLanguage.html';
import tmpl_nds from './vplEnergyUpdateAccountMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyUpdateAccountMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
