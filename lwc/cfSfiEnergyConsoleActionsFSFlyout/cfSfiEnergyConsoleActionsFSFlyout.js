import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyConsoleActionsFSFlyout extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={sfiEnergyConsoleVerifyEntitlements:"Verify Entitlements",
      sfiEnergyConsoleNoEntitlementsMsg:"There are no Entitlements associated with this Account.",
