import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumerLandingTestimonialCard extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={VEETestimonial1:"The simplest and easiest plan I have purchased so far. Switch was very fast with constant support from the service agent.",
      VEETestimonial2:"It's easy to submit monthly meter readings, and the pricing is fair. I am also impressed that they are trying to transition to cleaner greener energy resources",
      VEETestimonial3:"I would definitely recommend Quality Watts to my friends and family."
      };
              pubsubEvent = [];
              customEvent = [];
