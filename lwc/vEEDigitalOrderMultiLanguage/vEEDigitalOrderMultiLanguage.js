...
import { OMNIDEF } from './vEEDigitalOrderMultiLanguage_def.js';
import tmpl from './vEEDigitalOrderMultiLanguage.html';
import tmpl_nds from './vEEDigitalOrderMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vEEDigitalOrderMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
