...
import { OMNIDEF } from './vplEnergyManualMeterReadMultiLanguage_def.js';
import tmpl from './vplEnergyManualMeterReadMultiLanguage.html';
import tmpl_nds from './vplEnergyManualMeterReadMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyManualMeterReadMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
