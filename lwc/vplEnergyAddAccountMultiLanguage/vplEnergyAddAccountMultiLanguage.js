...
import { OMNIDEF } from './vplEnergyAddAccountMultiLanguage_def.js';
import tmpl from './vplEnergyAddAccountMultiLanguage.html';
import tmpl_nds from './vplEnergyAddAccountMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyAddAccountMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
