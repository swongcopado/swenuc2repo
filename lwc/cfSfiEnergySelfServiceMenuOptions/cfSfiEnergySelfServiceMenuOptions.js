import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergySelfServiceMenuOptions extends FlexCardMixin(LightningElement){
              ...
              @track Label={sfiEnergySelfServiceMyProfile:"My Profile",
        sfiEnergySelfServiceNotificationPreference:"Notification Preference",
        sfiEnergySelfServiceLogout:"Logout"
        };
              pubsubEvent = [];
              customEvent = [];
