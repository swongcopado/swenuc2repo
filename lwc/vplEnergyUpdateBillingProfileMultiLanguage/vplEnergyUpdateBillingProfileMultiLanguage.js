...
import { OMNIDEF } from './vplEnergyUpdateBillingProfileMultiLanguage_def.js';
import tmpl from './vplEnergyUpdateBillingProfileMultiLanguage.html';
import tmpl_nds from './vplEnergyUpdateBillingProfileMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyUpdateBillingProfileMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
