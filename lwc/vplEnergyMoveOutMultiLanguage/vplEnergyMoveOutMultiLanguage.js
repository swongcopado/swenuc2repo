...
import { OMNIDEF } from './vplEnergyMoveOutMultiLanguage_def.js';
import tmpl from './vplEnergyMoveOutMultiLanguage.html';
import tmpl_nds from './vplEnergyMoveOutMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyMoveOutMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
