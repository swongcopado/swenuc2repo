import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergySelfServicePlanDetailsContainer extends FlexCardMixin(LightningElement){
        ...
        @api set cfLastName(val) {
          ...
          return this._sessionApiVars["LastName"] || "";
              ...
              @track Label={sfiEnergySelfServicePlanDetails:"Plan Details"
        };
              pubsubEvent = [];
              customEvent = [];
