...
import { OMNIDEF } from './vplEnergyCreatePaymentPlanMultiLanguage_def.js';
import tmpl from './vplEnergyCreatePaymentPlanMultiLanguage.html';
import tmpl_nds from './vplEnergyCreatePaymentPlanMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyCreatePaymentPlanMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
