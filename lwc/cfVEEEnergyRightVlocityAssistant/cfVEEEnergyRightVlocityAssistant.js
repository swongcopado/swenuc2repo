import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEEnergyRightVlocityAssistant extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={VEEConsoleVlocityAssistant:"Vlocity Assistant",
      VEEConsoleHideVlocityAssistant:"Hide Vlocity Assistant",
      VEEConsoleShowVlocityAssistant:"Show Vlocity Assistant",
      VEEConsoleVlocityAssistantComponent:"Vlocity Assistant Component"
      };
              connectedCallback() {
