import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumerTotalSummaryDetails extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfVEEConsumerTotalSummaryDetails';
              ...
              @track Label={VEEUsageTotal:"Usage Total",
      VEEOneTimeTotal:"One Time Total",
      VEEMonthlyTotal:"Monthly Total"
      };
              pubsubEvent = [];
              customEvent = [];
