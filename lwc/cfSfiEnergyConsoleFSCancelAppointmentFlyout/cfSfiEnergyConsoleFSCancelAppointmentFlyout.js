import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyConsoleFSCancelAppointmentFlyout extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={sfiEnergyConsoleFSCancelAppointment:"Cancel Appointment",
      sfiEnergyConsoleFSCancelAppointmentMsg:"The appointment scheduled on",
      sfiEnergyConsoleFSCancelAppointmentMsgCont:"will be cancelled",
