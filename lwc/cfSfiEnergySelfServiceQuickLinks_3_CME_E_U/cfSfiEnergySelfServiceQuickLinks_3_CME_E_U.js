import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergySelfServiceQuickLinks_3_CME_E_U extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfSfiEnergySelfServiceQuickLinks_3_CME_E_U';
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`sfiEnergySelfServiceQuickLinks`,this._allMergeFields,this._regexPattern,"noparse");
