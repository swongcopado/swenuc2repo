import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumerConfirmationCard extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={VEEThankYouMessage:"Great to have you. Looking forward to serve you !!",
      VEEConfirmationMessage:"Thank you, your enrollment is successful. Your Request Reference Number is : ",
      VEEThankYou:"Thank You"
      };
              pubsubEvent = [];
              customEvent = [];
