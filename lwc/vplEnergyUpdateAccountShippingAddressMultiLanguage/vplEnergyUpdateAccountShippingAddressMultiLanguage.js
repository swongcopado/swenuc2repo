...
import { OMNIDEF } from './vplEnergyUpdateAccountShippingAddressMultiLanguage_def.js';
import tmpl from './vplEnergyUpdateAccountShippingAddressMultiLanguage.html';
import tmpl_nds from './vplEnergyUpdateAccountShippingAddressMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyUpdateAccountShippingAddressMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
