import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumerOfferChildProducts extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @track omniSupportKey = 'cfVEEConsumerOfferChildProducts';
              @track record;

              _regexPattern = /\{([a-zA-Z.0-9_]*)\}/g; //for {} fields by default
              @track Label={VEETotalStandingPrice:"Standing Charge Total",
      VEETotalUnitPrice:"Usage Charge Total",
      ...
      VEECommodityOfferLabel:"Selected Tariff Plan"
      };
              connectedCallback() {
