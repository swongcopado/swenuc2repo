import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyConsoleFSReScheduleAppointmentFlyout extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              @track Label={sfiEnergyConsoleFSRescheduleAppointment:"Reschedule Appointment",
      sfiEnergyConsoleFSRescheduleAppointmentMsg:"The appointment scheduled on",
      sfiEnergyConsoleFSRescheduleAppointmentMsgCont:"will be rescheduled",
      sfiEnergyConsoleFSLabelOk:"Ok"
      };
              connectedCallback() {
