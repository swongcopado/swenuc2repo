import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEEnergyCustomerStoryOrder extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
      ...
      VEEConsoleTotalAmount:"Total Amount",
      VEEConsoleActivityDate:"Activity Date"
      };
              connectedCallback() {
