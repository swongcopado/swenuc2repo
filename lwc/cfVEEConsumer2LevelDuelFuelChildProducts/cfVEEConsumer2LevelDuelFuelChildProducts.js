import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumer2LevelDuelFuelChildProducts extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfVEEConsumer2LevelDuelFuelChildProducts';
              ...
              @track Label={VEECommodityOfferLabel:"Selected Tariff Plan",
      VEEUsageCost:"Estimated Monthly cost",
      VEEOfferDetails:"Plan Details",
      VEEElectricityConsumptionLabel:"Estimated Electricity Consumption (in kWh)",
      VEEGasConsumptionLabel:"Estimated Gas Consumption (in kWh)",
      VEETotalElectricityPrice:"Total Electricity Price",
      VEETotalGasPrice:"Total Gas Price"
      };
              pubsubEvent = [];
              customEvent = [];
