...
import { OMNIDEF } from './vplEnergyMoveInMultiLanguage_def.js';
import tmpl from './vplEnergyMoveInMultiLanguage.html';
import tmpl_nds from './vplEnergyMoveInMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyMoveInMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
