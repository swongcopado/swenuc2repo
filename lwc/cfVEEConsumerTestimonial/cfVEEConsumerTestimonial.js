import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEConsumerTestimonial extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={VEETestimonialMsg:"I found the service easy to use and straightforward. The information  was clear and allowed me to quickly analyse the options and choose which would be best for the Charity. I would definitely recommend the service.",
      VEETestimonialHeader:"Testimonials"
      };
              pubsubEvent = [];
              customEvent = [];
