...
import { OMNIDEF } from './vplEnergyUpdateCaseMultiLanguage_def.js';
import tmpl from './vplEnergyUpdateCaseMultiLanguage.html';
import tmpl_nds from './vplEnergyUpdateCaseMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyUpdateCaseMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
