...
import { OMNIDEF } from './vplEnergyManageProfileAttributesMultiLanguage_def.js';
import tmpl from './vplEnergyManageProfileAttributesMultiLanguage.html';
import tmpl_nds from './vplEnergyManageProfileAttributesMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyManageProfileAttributesMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
