import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEEnergyCustomerStoryCardHeader extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={VEEConsoleCustomerStory:"Customer Story",
      VEEConsoleCase:"Case",
      VEEConsoleTask:"Task",
      VEEConsoleOrder:"Order",
      VEEConsoleEvent:"Event",
      VEEConsoleOpportunity:"Opportunity",
      VEEConsoleNewLabel:"New"
      };
              pubsubEvent = [];
              customEvent = [];
