import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyConsoleFSNeedsAttention_1_CME_E_U extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={sfiEnergyConsoleFSNoOutage:"sfiEnergyConsoleFSNoOutage",
      sfiEnergyConsoleFSViewAll:"sfiEnergyConsoleFSViewAll",
      sfiEnergyConsoleFSEstRestoration:"sfiEnergyConsoleFSEstRestoration",
      sfiEnergyConsoleFSInitiatedAt:"sfiEnergyConsoleFSInitiatedAt",
      sfiEnergyConsoleFSLocations:"sfiEnergyConsoleFSLocations",
      sfiEnergyConsoleFSOutageReported:"sfiEnergyConsoleFSOutageReported",
      sfiEnergyConsoleFSNeedAttention:"sfiEnergyConsoleFSNeedAttention"
      };
              pubsubEvent = [];
              customEvent = [];
