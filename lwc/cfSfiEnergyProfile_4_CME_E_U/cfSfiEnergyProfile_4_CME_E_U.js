import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyProfile_4_CME_E_U extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`energyprofileinterestadded`,this._allMergeFields,this._regexPattern,"noparse");
