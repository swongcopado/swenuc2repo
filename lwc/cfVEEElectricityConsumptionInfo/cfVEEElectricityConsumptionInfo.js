import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfVEEElectricityConsumptionInfo extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfVEEElectricityConsumptionInfo';
              ...
              @track Label={VEEConsumptionInfoMsgTitle:"Estimating consumption",
      VEEElecLowUsageMsg:"Typically, low consumption homes: Have around 1-2 bedrooms, Have 2-3 occupants, May have people home during the day",
      VEEElecHighUsageMsg:"Typically, high consumption homes: Have around 8 bedrooms, Have 8-10 occupants, May have people home during the day",
      VEEElecMediumUsageMsg:"Typically, medium consumption homes: Have around 3 bedrooms, Have 3-5 occupants, May have people home during the day"
      };
              pubsubEvent = [];
              customEvent = [];
