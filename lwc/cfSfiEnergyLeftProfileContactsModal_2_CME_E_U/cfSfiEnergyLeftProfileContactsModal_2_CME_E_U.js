import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyLeftProfileContactsModal_2_CME_E_U extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={SfiEnergyConsoleAllContacts:"All Contacts",
      sfiEnergyConsoleNoRecords:"No records to display"
      };
              pubsubEvent = [];
              customEvent = [];
