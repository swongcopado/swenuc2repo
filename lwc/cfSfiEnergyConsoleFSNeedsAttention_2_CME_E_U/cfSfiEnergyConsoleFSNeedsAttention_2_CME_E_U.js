import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyConsoleFSNeedsAttention_2_CME_E_U extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={SfiEnergyConsoleFSNeedAttention:"Needs Attention",
      SfiEnergyConsoleFSOutageReported:"Outage reported at",
      SfiEnergyConsoleFSLocations:"location(s)",
      SfiEnergyConsoleFSInitiatedAt:"Initiated at",
      SfiEnergyConsoleFSEstRestoration:"Expected resolution by",
      sfiEnergyConsoleFSViewAll:"sfiEnergyConsoleFSViewAll",
      SfiEnergyConsoleFSViewAll:"View All",
      SfiEnergyConsoleFSNoOutage:"No outages around Account's premises at this time"
      };
              pubsubEvent = [];
              customEvent = [];
