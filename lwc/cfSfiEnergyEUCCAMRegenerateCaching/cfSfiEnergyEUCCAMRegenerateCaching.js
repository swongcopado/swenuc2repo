import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSfiEnergyEUCCAMRegenerateCaching extends FlexCardMixin(LightningElement){
              ...
              @track Label={SfiEnergyCAMVIPCacheDesc1:"This Job runs the Vlocity scheduled job",
        ...
        SfiEnergyCAMRegenCacheCustomSettingName:"sfiEnergyCAMModifiedProductsCode.",
        SfiEnergyCAMRegenCacheDesc2:"to regenerate cached API Response for all modified products mentioned in custom settings",
        SfiEnergyCAMRegenCache:"REGENERATE CACHE JOB"
        };
              pubsubEvent = [];
              customEvent = [];
