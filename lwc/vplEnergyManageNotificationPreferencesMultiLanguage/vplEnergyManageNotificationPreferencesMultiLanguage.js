...
import { OMNIDEF } from './vplEnergyManageNotificationPreferencesMultiLanguage_def.js';
import tmpl from './vplEnergyManageNotificationPreferencesMultiLanguage.html';
import tmpl_nds from './vplEnergyManageNotificationPreferencesMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vplEnergyManageNotificationPreferencesMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
